...
const FormInput = ({
  ...
  const variantClasses = {
    ...
    secondary:
      'w-full mt-0 !border !border-[#D1E2F0] dark:!border-[#1F2F41] bg-white dark:bg-transparent text-black dark:text-white placeholder-[#24527A] dark:placeholder-gray-400 py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500',
  };
