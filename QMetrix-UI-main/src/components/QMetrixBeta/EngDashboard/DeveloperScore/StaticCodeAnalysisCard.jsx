    ...
    return (
        ...
        >
            ...
            <div className="flex-grow flex flex-col">
                <h4 className={`text-md font-semibold mb-2 ${theme === 'light' ? 'text-[#0A2342]' : 'dark:text-gray-300'}`}>Metrics</h4>
                <div className={`grid grid-cols-2 gap-y-2 gap-x-4 text-sm flex-grow ${theme === 'light' ? 'text-[#24527A]' : 'dark:text-gray-400'}` }>
...
StaticCodeAnalysisCard.propTypes = {
...
export default StaticCodeAnalysisCard;
